...
jest.mock('./SensorTable.js', () => function MockSensorTable() {
  return null;
});
jest.mock('./Sensor_Components/SensorTableV2.js', () => function MockSensorTableV2() {
  return null;
});

import { renderWithProviders, screen, waitFor } from '../test-utils';
import RegFamilyTiles from './RegFamilyTiles.js';
